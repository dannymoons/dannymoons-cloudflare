...
import { logServerError } from "@/utilities/logServerError";
...
export default async function GlossaryEntryPage({
  ...
  try {
    ...
    logServerError("glossary-page-render", error, { slug: decodedSlug });
    throw error;
  }
}
...
export async function generateMetadata({
  ...
  try {
    ...
    logServerError("glossary-metadata", error, { slug: decodedSlug });
    throw error;
  }
...
const queryGlossaryBySlug = cache(async (slug: string) => {
  ...
  try {
    ...
    logServerError("glossary-query", error, { slug, draft: String(draft) });
    throw error;
  }
});
