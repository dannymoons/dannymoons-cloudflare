    ...
    <>
      <SchemaPage
        ...
        person={{
          ...
          description: SITE_DESCRIPTION,
          jobTitle: 'Sustainable Web Developer'
        }}
        faqPage={{
          ...
          <Container size='wide'>
            <div className='grid gap-8 lg:grid-cols-[0.72fr_1fr] lg:items-end'>
              ...
              <p className='max-w-xl text-base text-muted-foreground leading-7 lg:justify-self-end'>
                ...
                projects: ideas, experiments, and lessons that are still
                evolving.
              </p>
            </div>
        ...
        >
          <Container size='wide'>
            ...
            <div className='mt-14 grid gap-3 lg:grid-cols-12'>
              ...
              >
                Makes website impact and performance visible, so teams can
                improve with intent.
              </ProjectCard>
            </div>
          </Container>
            ...
            <div className='grid gap-12 lg:grid-cols-[0.42fr_1fr] lg:gap-20'>
              ...
              <div>
                <p className='max-w-4xl text-2xl text-foreground/92 leading-[1.35] tracking-[-0.025em] sm:text-3xl sm:leading-[1.3]'>
                  The next generation of software should not be defined by one
                  new framework. It will emerge where responsibility,
                  intelligence, and clear technical judgment reinforce each
                  other.
                </p>
            ...
            <div className='grid gap-10 lg:grid-cols-[0.72fr_1fr] lg:items-start lg:gap-16'>
              <div className='lg:sticky lg:top-24'>
                ...
                <p className='mt-6 max-w-md text-base text-muted-foreground leading-7'>
                  Straight answers to the questions that come up most, without
                  the sales talk.
                </p>
              </div>
          ...
          <Container size='narrow'>
            <div>
              ...
              <p className='mt-8 max-w-3xl text-muted-foreground text-xl leading-8 sm:text-2xl sm:leading-9'>
                ...
                show how ideas hold up in practice, and help others make
                software that earns its place in the world.
              </p>
            </div>
          </Container>
        </section>
