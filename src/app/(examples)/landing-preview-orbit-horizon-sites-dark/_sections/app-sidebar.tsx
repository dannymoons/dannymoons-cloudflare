...
export function AppSidebar({ active }: { active: NavKey }) {
	return (
		<aside className='sticky top-0 hidden h-dvh w-56 shrink-0 flex-col border-[var(--stroke)] border-r-2 [background:var(--panel)] lg:flex'>
			<div className='flex items-center gap-2.5 border-[var(--stroke)] border-b-2 px-4 py-4'>
				<span className='grid h-8 w-8 shrink-0 place-items-center border-2 border-[var(--stroke-strong)] [background:color-mix(in_oklch,var(--olive)_20%,var(--panel))] [color:var(--sage)]'>
			...
			<div className='border-[var(--stroke)] border-t-2 p-3'>
				<Link
					href='/landing-preview-orbit-horizon-dark'
					className='flex min-h-11 items-center gap-2.5 border-2 border-transparent px-3 font-[family-name:var(--font-mono)] text-[11px] uppercase tracking-[0.12em] [color:var(--mute)] hover:border-[var(--stroke)] hover:[color:var(--ink)]'
				>
