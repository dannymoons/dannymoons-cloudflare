		...
		<section className='rounded-xl border border-[var(--line)] p-4 [background:var(--panel)] sm:p-5'>
			...
			<ol className='space-y-3'>
				{LEVELS.map(l => (
					...
					>
						<span className='absolute top-3 left-3 flex h-6 w-6 items-center justify-center rounded-full font-[family-name:var(--font-display)] font-bold text-[10px] text-[oklch(0.12_0.02_265)] [background:var(--orbit)]'>
							{l.level}
						</span>
			...
			<button
				type='button'
				className='mt-3 w-full rounded-lg border border-[var(--line)] border-dashed py-2 text-[11px] [color:var(--mute)] hover:[color:var(--orbit)]'
			>
				+ Add escalation step
			</button>
		</section>
