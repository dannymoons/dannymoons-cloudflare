	...
	return (
		...
		>
			<div className='mx-auto max-w-5xl text-center'>
				...
				<div className='oh-reveal mt-12 grid grid-cols-2 gap-4 sm:grid-cols-4'>
					{integrations.map(item => (
						<div
							key={item.name}
							className='flex flex-col items-center border-2 border-[var(--ink)] px-4 py-6 [background:var(--panel)]'
						>
							<span className='grid h-12 w-12 place-items-center border border-[var(--ink)] font-[family-name:var(--font-display)] font-bold text-lg [background:var(--surface)] [color:var(--ink)]'>
								{item.initial}
							</span>
