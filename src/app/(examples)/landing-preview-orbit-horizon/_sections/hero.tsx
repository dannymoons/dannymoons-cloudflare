...
export function Hero() {
	return (
		<section className='relative px-5 pt-16 pb-20 sm:px-8 sm:pt-24 sm:pb-28'>
			...
			<span className='oh-reveal mx-auto flex max-w-fit items-center gap-2 rounded-full border border-[color-mix(in_oklch,var(--olive)_25%,var(--line))] px-3 py-1 font-[family-name:var(--font-mono)] text-[11px] uppercase tracking-[0.22em] [color:var(--mute)]'>
				<span className='h-1.5 w-1.5 animate-pulse rounded-full [background:var(--olive)]' />
				Page-level carbon tracking
			</span>

			<h1 className='oh-reveal mx-auto mt-8 max-w-4xl text-balance text-center font-[family-name:var(--font-display)] font-semibold text-[clamp(2.5rem,7vw,5rem)] leading-[1.03] tracking-[-0.02em]'>
				See every page&rsquo;s{' '}
				<span className='italic [color:var(--olive)]'>carbon footprint</span>
			</h1>

			<p className='oh-reveal mx-auto mt-6 max-w-xl text-balance text-center text-sm leading-relaxed [color:var(--mute)] sm:text-base'>
			...
			<div className='oh-reveal mx-auto mt-10 max-w-3xl overflow-hidden border-2 border-[var(--ink)] shadow-[6px_6px_0_oklch(0.22_0.03_145)] [background:var(--panel)]'>
			...
			<div className='oh-reveal mt-10 flex flex-col items-center justify-center gap-3 sm:flex-row'>
				<a
					href='#trial'
					className='group inline-flex min-h-12 cursor-pointer items-center gap-2 border-2 border-[var(--ink)] px-6 font-[family-name:var(--font-body)] font-semibold text-sm [background:var(--ink)] [color:var(--parchment)]'
				>
					Start free trial
				...
				<a
					href='#dashboard'
					className='inline-flex min-h-12 cursor-pointer items-center gap-2 border-2 border-[var(--ink)] px-6 font-[family-name:var(--font-body)] font-medium text-sm [color:var(--ink)] hover:[background:var(--ink)] hover:[color:var(--parchment)]'
				>
					View live demo
				</a>
			</div>
