		...
		<section id='benchmarks' className='px-5 py-20 sm:px-8 sm:py-28'>
			<div className='mx-auto max-w-5xl'>
				<div className='mb-12 text-center'>
					<span className='oh-reveal mb-3 block font-[family-name:var(--font-mono)] text-[11px] uppercase tracking-[0.24em] [color:var(--ink)]'>
						Benchmarks
					</span>
					...
					<p className='oh-reveal mx-auto mt-4 max-w-lg text-sm [color:var(--mute)]'>
				...
				<div className='grid gap-6 sm:grid-cols-2'>
					{comparisons.map(c => {
						...
						return (
							<article
								key={c.label}
								className='oh-reveal border-2 border-[var(--ink)] p-5 [background:var(--panel)] sm:p-6'
							>
