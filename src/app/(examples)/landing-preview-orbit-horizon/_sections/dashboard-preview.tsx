			...
			<div className='mx-auto max-w-5xl'>
				<div className='mb-10 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between'>
					<div>
						...
						<p className='oh-reveal mt-3 max-w-md text-sm [color:var(--mute)]'>
							Average grams CO₂ per page view across all tracked URLs. Hover
							data points for monthly detail.
						</p>
					</div>
					<div className='oh-reveal flex flex-wrap gap-4 text-xs'>
				...
				<div className='oh-reveal overflow-hidden border-2 border-[var(--ink)] [background:var(--panel)]'>
