			...
			<div className='mx-auto max-w-5xl'>
				<div className='grid items-start gap-10 lg:grid-cols-2'>
					<div>
						...
						<p className='oh-reveal mt-4 text-sm leading-relaxed [color:var(--mute)]'>
						...
						<a
							href='#trial'
							className='oh-reveal mt-8 inline-flex min-h-12 cursor-pointer items-center border border-[color-mix(in_oklch,var(--olive)_45%,transparent)] px-6 font-[family-name:var(--font-body)] font-medium text-sm [background:var(--ink)] [color:var(--parchment)]'
						>
							Add your first site
						</a>
					</div>

					<div className='oh-reveal space-y-3'>
						{sites.map((s, i) => (
							<article
								key={s.domain}
								className='flex items-center gap-4 border-2 border-[var(--ink)] p-4 [background:var(--panel)] sm:p-5'
						...
						<button
							type='button'
							className='flex min-h-12 w-full cursor-pointer items-center justify-center gap-2 border-2 border-[var(--ink)] border-dashed text-xs transition-colors [color:var(--mute)] hover:[background:var(--surface)] hover:[color:var(--ink)]'
						>
