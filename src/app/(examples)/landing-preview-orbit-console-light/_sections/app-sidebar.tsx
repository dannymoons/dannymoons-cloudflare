...
const NAV: {
...
}[] = [
	{
		key: 'overview',
		label: 'Overview',
		href: '/landing-preview-orbit-console-light',
	...
	return (
		<aside className='sticky top-0 hidden h-dvh w-56 shrink-0 flex-col border-[var(--line)] border-r [background:var(--panel)] lg:flex'>
			<div className='flex items-center gap-2 border-[var(--line)] border-b px-4 py-4'>
				<span className='flex h-8 w-8 items-center justify-center rounded-lg font-[family-name:var(--font-display)] font-bold text-[var(--on-accent)] text-xs [background:var(--orbit)]'>
					O
				</span>
