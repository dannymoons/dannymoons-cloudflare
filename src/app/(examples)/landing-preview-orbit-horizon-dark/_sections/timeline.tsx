	...
	return (
		<section className='border-[var(--line)] border-y px-5 py-20 [background:color-mix(in_oklch,var(--sage)_8%,var(--parchment))] sm:px-8 sm:py-28'>
			<div className='mx-auto max-w-5xl'>
				...
				<p className='ohd-reveal mt-3 max-w-xl text-sm [color:var(--mute)]'>
				...
				<div className='ohd-reveal mt-12 grid gap-4 sm:grid-cols-3'>
					{views.map(v => (
						<article
							key={v.id}
							className={`flex flex-col border-2 border-[var(--stroke)] p-5 sm:p-6 ${
								v.labelAccent
				...
				<div className='ohd-reveal mt-10 flex items-center gap-3 overflow-x-auto pb-2'>
					{(
						[
							'Jan',
							'Feb',
