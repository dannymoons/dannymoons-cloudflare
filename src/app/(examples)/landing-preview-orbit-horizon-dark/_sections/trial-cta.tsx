...
export function TrialCta() {
	return (
		<section id='trial' className='px-5 py-24 sm:px-8 sm:py-32'>
			<div className='ohd-reveal mx-auto max-w-xl border-2 border-[var(--stroke)] p-6 shadow-[8px_8px_0_var(--shadow)] [background:color-mix(in_oklch,var(--sage)_8%,var(--panel))] sm:p-10'>
				...
				<form className='mt-8 space-y-4' action='#trial' method='get'>
					<div>
						...
						<input
							...
							className='min-h-12 w-full border border-[var(--stroke)] bg-transparent px-4 text-sm outline-none transition-colors [color:var(--ink)] focus:border-2 focus:border-[var(--olive)]'
						/>
					</div>
					<div>
						<label
					...
					<button
						type='submit'
						className='group flex min-h-12 w-full cursor-pointer items-center justify-center gap-2 border-2 border-[var(--stroke-strong)] font-[family-name:var(--font-body)] font-semibold text-sm [background:color-mix(in_oklch,var(--olive)_24%,var(--surface))] [color:var(--ink)]'
					>
						Start free trial
