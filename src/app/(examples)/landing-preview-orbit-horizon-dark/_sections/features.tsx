			...
			<div className='mx-auto max-w-5xl'>
				...
				<div className='grid gap-4 sm:grid-cols-2 lg:grid-cols-3'>
					{features.map(f => (
						<article
							key={f.title}
							className='ohd-reveal group border-2 border-[var(--stroke)] p-5 [background:var(--panel)] sm:p-6'
						>
							<span className='grid h-10 w-10 place-items-center border border-[var(--stroke)]'>
