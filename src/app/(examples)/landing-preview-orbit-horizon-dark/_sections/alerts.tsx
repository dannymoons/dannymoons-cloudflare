		...
		<section className='border-[var(--line)] border-y px-5 py-20 [background:color-mix(in_oklch,var(--sage)_8%,var(--parchment))] sm:px-8 sm:py-28'>
			<div className='mx-auto max-w-5xl'>
				<div className='mb-10 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between'>
					...
					<div className='ohd-reveal flex gap-3 font-[family-name:var(--font-mono)] text-[10px] uppercase tracking-widest'>
				...
				<ul className='ohd-reveal space-y-3'>
					{alerts.map(a => (
						<li
							key={`${a.site}${a.page}`}
							className='flex flex-col gap-3 border-2 border-[var(--stroke)] p-4 [background:var(--panel)] sm:flex-row sm:items-center sm:justify-between sm:p-5'
						>
