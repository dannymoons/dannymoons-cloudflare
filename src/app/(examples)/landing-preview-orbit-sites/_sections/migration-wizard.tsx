		...
		<section className='rounded-xl border border-[var(--line)] p-4 [background:var(--panel)] sm:p-5'>
			...
			{step === 0 ? (
				...
				<ul className='space-y-2 text-xs'>
					<li className='flex justify-between rounded-lg border border-[var(--line)] p-2 [background:var(--surface)]'>
						...
						<span className='[color:var(--mint)]'>Mapped</span>
					</li>
					<li className='flex justify-between rounded-lg border border-[var(--line)] p-2 [background:var(--surface)]'>
				...
				<p className='text-xs [color:var(--mint)]'>
			...
			<div className='mt-4 flex gap-2'>
				...
				<button
					...
					className='flex-1 rounded-lg py-2 font-medium text-[11px] text-[oklch(0.12_0.02_265)] [background:var(--orbit)]'
				>
