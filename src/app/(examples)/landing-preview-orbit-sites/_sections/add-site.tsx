		...
		<section className='rounded-xl border border-[var(--line)] p-4 [background:var(--panel)] sm:p-5'>
			...
			{step === 'form' ? (
				...
				<div className='space-y-3'>
					...
					<code className='block overflow-x-auto rounded-lg border border-[var(--line)] p-3 text-[10px] [background:var(--surface)] [color:var(--mint)]'>
					...
					<div className='flex gap-2'>
						...
						<button
							type='button'
							className='flex-1 rounded-lg py-2 font-medium text-[11px] text-[oklch(0.12_0.02_165)] [background:var(--mint)]'
						>
							Verify DNS
						</button>
					</div>
