			...
			<ul className='grid gap-3 sm:grid-cols-2'>
				{channels.map(ch => {
					...
					return (
						<li
							key={ch.id}
							className='flex items-start gap-3 border-2 border-[var(--stroke)] shadow-[4px_4px_0_var(--shadow)] p-3 [background:var(--surface)]'
						>
							<span className='flex h-9 w-9 shrink-0 items-center justify-center rounded-lg [background:color-mix(in_oklch,var(--olive)_12%,transparent)]'>
								<Icon className='h-4 w-4 [color:var(--olive)]' />
							</span>
