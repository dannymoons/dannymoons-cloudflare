...
const emissions = [
	0.52, 0.49, 0.47, 0.45, 0.43, 0.41, 0.39, 0.38, 0.36, 0.34, 0.32, 0.31
]
				...
				<div className='mb-10 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between'>
					<div>
						...
						<h2 className='on-reveal font-[family-name:var(--font-display)] font-semibold text-[clamp(1.75rem,4vw,2.75rem)] tracking-[-0.02em]'>
							lab.orbit.research — 12 month trend
						</h2>
						<p className='on-reveal mt-3 max-w-md text-sm [color:var(--mute)]'>
							Average grams CO₂ per page view across tracked AI workloads and
							static pages. Hover data points for monthly detail.
						</p>
					</div>
					<div className='on-reveal flex flex-wrap gap-4 text-xs'>
						<span className='flex items-center gap-2'>
							<span className='h-2 w-6 rounded-sm [background:var(--olive)]' />
							Site average
						</span>
						<span className='flex items-center gap-2 [color:var(--mute)]'>
							<span className='h-2 w-6 rounded-sm border border-[color-mix(in_oklch,var(--sage)_60%,transparent)] border-dashed [background:color-mix(in_oklch,var(--sage)_20%,transparent)]' />
							Research target
						</span>
					</div>
				</div>

				<div className='on-reveal overflow-hidden rounded-xl border border-[var(--line)] shadow-[0_1px_0_0_var(--line)] [background:var(--parchment)]'>
					<div className='flex flex-wrap items-center justify-between gap-3 border-[var(--line)] border-b px-4 py-3 sm:px-6'>
						<div className='flex items-baseline gap-3'>
							...
							<span className='rounded-full border border-[color-mix(in_oklch,var(--sage)_45%,transparent)] px-2 py-0.5 text-[10px] [color:var(--olive)]'>
								−40% YoY
							</span>
						</div>
						<select
							className='min-h-12 rounded-md border border-[var(--line)] bg-transparent px-3 text-xs [color:var(--ink)]'
					...
					<div className='relative px-2 py-6 sm:px-4'>
						<svg
							...
							role='img'
							aria-label='Area chart showing monthly carbon emissions declining from 0.52 to 0.31 grams CO2 per visit'
						>
							<defs>
								<linearGradient id='nous-area-fill' x1='0' y1='0' x2='0' y2='1'>
									<stop
										offset='0%'
										stopColor='var(--sage)'
										stopOpacity='0.35'
								...
								<linearGradient id='nous-line' x1='0' y1='0' x2='1' y2='0'>
							...
							<path d={areaPath} fill='url(#nous-area-fill)' />
							<path
								d={linePath}
								fill='none'
								stroke='url(#nous-line)'
								strokeWidth='2.5'
								strokeLinecap='round'
							...
							<line
								x1={padX}
								x2={chartW - padX}
								y1={padY + 0.55 * (chartH - padY * 2)}
								y2={padY + 0.55 * (chartH - padY * 2)}
								stroke='var(--clay)'
								strokeWidth='1'
								strokeDasharray='4 4'
								opacity='0.7'
