	...
	return (
		<section className='border border-[var(--stroke)] shadow-[4px_4px_0_var(--shadow)] p-4 [background:var(--panel)] sm:p-5'>
			...
			<div className='flex flex-col gap-3 sm:flex-row sm:items-end'>
							...
							<button
								...
								className={`flex-1 rounded-md py-1.5 font-medium text-[11px] transition-colors ${
									format === f
										...
										: '[color:var(--mute)] hover:[color:var(--ink)]'
								}`}
							>
								{f}
							</button>
				...
				<button
					type='button'
					className='h-9 shrink-0 rounded-lg px-4 font-medium text-[oklch(0.12_0.02_265)] text-xs [background:var(--olive)] hover:opacity-90'
				>
					Download {format}
				</button>
			</div>
