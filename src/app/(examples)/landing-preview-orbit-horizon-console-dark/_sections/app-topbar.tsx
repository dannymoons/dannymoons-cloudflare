...
export function AppTopbar({ title, site }: { title: string; site: string }) {
	return (
		<header className='sticky top-0 z-20 flex flex-wrap items-center gap-3 border-[var(--stroke)] border-b px-4 py-3 [background:var(--parchment)] sm:px-6'>
			...
			<div className='relative hidden min-w-[200px] flex-1 sm:block sm:max-w-xs'>
				...
				<input
					...
					className='h-10 w-full border border-[var(--stroke)] pr-3 pl-9 font-[family-name:var(--font-mono)] text-xs outline-none [background:var(--panel)] focus:border-[var(--stroke-strong)] focus:shadow-[3px_3px_0_var(--shadow)]'
			...
			<div className='flex items-center gap-2'>
				<button
					type='button'
					className='relative flex h-10 w-10 items-center justify-center border border-[var(--stroke)] [background:var(--panel)] [color:var(--mute)] hover:border-[var(--stroke-strong)] hover:shadow-[3px_3px_0_var(--shadow)] hover:[color:var(--ink)]'
				...
				<button
					type='button'
					className='flex items-center gap-2 border border-[var(--stroke)] py-1 pr-2 pl-1 [background:var(--panel)] hover:border-[var(--stroke-strong)] hover:shadow-[3px_3px_0_var(--shadow)]'
