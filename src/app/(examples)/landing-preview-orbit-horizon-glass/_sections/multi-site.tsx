			...
			<div className='mx-auto max-w-5xl'>
				<div className='grid items-start gap-10 lg:grid-cols-2'>
					<div>
						...
						<p className='ohg-reveal mt-4 text-sm leading-relaxed [color:var(--mute)]'>
						...
						<a
							href='#trial'
							className='ohg-reveal mt-8 inline-flex min-h-12 cursor-pointer items-center ohg-glass ohg-glass-strong rounded-2xl px-6 font-[family-name:var(--font-body)] font-medium text-sm [background:color-mix(in_oklch,var(--olive)_24%,var(--surface))] [color:var(--ink)]'
						>
							Add your first site
						</a>
					</div>

					<div className='ohg-reveal space-y-3'>
						{sites.map((s, i) => (
							<article
								key={s.domain}
								className='flex items-center gap-4 ohg-glass rounded-2xl p-4  sm:p-5'
						...
						<button
							type='button'
							className='flex min-h-12 w-full cursor-pointer items-center justify-center gap-2 ohg-glass rounded-2xl border-dashed text-xs transition-colors [color:var(--mute)] hover:[background:var(--surface)] hover:[color:var(--ink)]'
						>
