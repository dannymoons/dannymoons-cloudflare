			...
			<div className='mx-auto max-w-5xl'>
				<div className='mb-10 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between'>
					<div>
						...
						<p className='ohg-reveal mt-3 max-w-lg text-sm [color:var(--mute)]'>
					...
					<div className='ohg-reveal flex gap-3 font-[family-name:var(--font-mono)] text-[10px] uppercase tracking-widest'>
				...
				<ul className='ohg-reveal space-y-3'>
					{alerts.map(a => (
						<li
							key={`${a.site}${a.page}`}
							className='flex flex-col gap-3 ohg-glass rounded-2xl p-4  sm:flex-row sm:items-center sm:justify-between sm:p-5'
						>
