...
const textSizes = {
  ...
  md: 'text-2xl @lg:text-4xl tracking-[-0.05em]',
  lg: 'text-2xl @xs:text-4xl @sm:text-5xl tracking-[-0.05em]',
  xl: 'text-3xl @xs:text-4xl @sm:text-5xl @2xl:text-6xl tracking-[-0.05em]'
}
