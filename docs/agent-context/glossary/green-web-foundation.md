...
date: 2026-08-05
slug: green-web-foundation
tags: [sustainability, tools, hosting]
aliases: [Green Web Foundation, GWF, thegreenwebfoundation.org]
reviewed: true
---

The Green Web Foundation is an independent organisation that keeps track of which web hosting providers use green energy. Think of it as a green energy certificate for the internet. But that's only one piece of their puzzle. They also provide datasets, CO2.js and training of sustainable software.
