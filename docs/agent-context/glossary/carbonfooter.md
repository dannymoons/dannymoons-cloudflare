...
Carbonfooter is a tool that checks whether a website runs on green energy. You type in a website address, and it tells you if the hosting provider uses renewable energy.
