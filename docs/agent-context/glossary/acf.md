...
aliases: [ACF, Advanced Custom Fields, ACF Pro]
reviewed: true
---

[ACF](https://www.advancedcustomfields.com) is a [WordPress](/what-is/wordpress) plugin that lets you add custom fields to pages and posts. It is one of the most popular WordPress plugins, and for good reason.
...
In 2025, I started moving some of my projects to [Payload CMS](/what-is/payload-cms), which handles custom fields in a more modern and structured way.
