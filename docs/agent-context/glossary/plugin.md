...
[WordPress](/what-is/wordpress) is famous for its plugin system. There are plugins for contact forms, online shops, speed optimization, security, and almost anything else. [ACF](/what-is/acf), which I use for custom fields, is a plugin.
