...
aliases: [design tokens, design system, tokens]
---
...
I prefer to define design tokens in tools like Penpot or Figma before building starts, so the entire site is built on a consistent foundation.